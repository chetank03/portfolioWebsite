...
export default function WorkExperience({ experiences }: Props) {
  return (
    ...
    >
      ...
      {/* Experience cards */}
      <div className="w-screen h-3/4 md:h-2/3 md:w-full text-left pb-5 md:pb-10 flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar-thin scrollbar-track-slate-800/40 scrollbar-thumb-darkGreen/80">
        {experiences
